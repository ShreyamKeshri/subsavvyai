  ...
  return (
    <Card>
      <CardHeader className="text-center">
        <CardTitle className="text-2xl font-bold">Welcome to Unsubscribr 🎯</CardTitle>
        <CardDescription>
          Track your subscriptions. Save ₹500-1000/month.
        </CardDescription>
      </CardHeader>
      ...
      <CardContent className="space-y-4">
        ...
        {method === 'phone' && (
          <div className="space-y-4">
            ...
            <Button
              ...
              disabled={loading || (!otpSent && !phoneNumber) || (otpSent && otp.length !== 6)}
              className="w-full"
              size="lg"
            >
              {loading ? (
        ...
        {/* Show method toggle only when not on phone method */}
        {method !== 'phone' && (
          <Button
            variant="outline"
