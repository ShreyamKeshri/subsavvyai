    ...
    return [
      {
        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-eval' 'unsafe-inline' https://vercel.live https://checkout.razorpay.com https://*.posthog.com https://*.ingest.sentry.io https://client.sleekplan.com https://api-client.sleekplan.com",
